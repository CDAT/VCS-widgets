...
var GraphicsMethodEditForm = _react2.default.createClass({
    ...
    addLabel: function addLabel(event) {
        ...
        var slider_value = Number.parseFloat((0, _jquery2.default)('#' + label_name + '-slider').val());
        if (this.props.gmProps[label_name][slider_value]) {
            ...
            var cur_gmProps = Object.assign({}, this.props.gmProps);
            if (cur_gmProps[label_name] !== null && _typeof(cur_gmProps[label_name]) === 'object') {
    ...
    updateLabel: function updateLabel(event) {
        ...
        var value = event.target.name.split('_')[1];
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                'div',
                                { id: 'xtl1-labels' },
                                this.props.gmProps['xticlabels1'] !== null && _typeof(this.props.gmProps['xticlabels1']) === 'object' ? Object.keys(this.props.gmProps['xticlabels1']).map(function (value, index) {
                                    return _react2.default.createElement(
                                        'div',
                                        ...
                                        _react2.default.createElement('input', { type: 'text',
                                            ...
                                            defaultValue: _this.props.gmProps['xticlabels1'][value],
